...
CCFLAGS :=$(CCSTD) $(PATH_HEADERS) -Wall -Wpedantic -Wconversion -O3
CFLAGS :=$(CSTD) $(PATH_HEADERS) -Wall -Wpedantic -Wconversion -O3
else
...
else #FOR MAC OR OTHER DEVICES SYSTEMS
CCFLAGS :=$(CCSTD) $(PATH_HEADERS) -Wall -Wpedantic -Wconversion -fsanitize=undefined -O3
CFLAGS :=$(CSTD) $(PATH_HEADERS) -Wall -Wpedantic -Wconversion  -fsanitize=undefined -O3
endif
endif
